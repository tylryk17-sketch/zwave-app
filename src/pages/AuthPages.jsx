        ...
        {step === 1 ? (
          <div>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'0.75rem', marginBottom:'1.5rem' }}>
              {roles.map(r => (
                <div key={r.id} onClick={() => setRole(r.id)} style={{ display:'flex', gap:'1rem', alignItems:'center', padding:'1rem 1.25rem', borderRadius:'12px', cursor:'pointer', border:`1px solid ${role===r.id?'var(--gold)':'var(--line)'}`, background:role===r.id?'rgba(184,122,20,0.05)':'var(--paper2)' }}>
